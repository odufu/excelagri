...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    const message = `
        Hi ${req.body.name}, Welcome to 'Excel AGRI' 🚀
...
exports.adminSignup = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    const otp = (newUser.otp = otpGenerator.generate(4, {
      upperProductAlphabets: false,
      specialChars: false,
      lowerProductAlphabets: false,
    }));
    await newUser.save({ validateBeforeSave: false });
...
exports.resendVerification = catchAsync(async(req, res, next)=>{
  ...
  const otp = user.otp = otpGenerator.generate(4, {upperProductAlphabets: false, specialChars: false, lowerProductAlphabets: false})
  await user.save({ validateBeforeSave: false})
...
exports.restrict = (...userTypes) => {
  return (req, res, next) => {
    // userTypes: ["Individual","Superuser", "Admin"]
